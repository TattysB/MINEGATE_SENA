...
class VisitaInterna(models.Model):
    ...
    nombre_programa = models.CharField(
        max_length=200, verbose_name="Nombre de programa", default=""
    )
    numero_ficha = models.PositiveIntegerField(
        verbose_name="Número de Ficha", default=0
    )
    ...
    documento_responsable = models.CharField(
        max_length=50, verbose_name="Documento del responsable", default=""
    )
    correo_responsable = models.EmailField(
        max_length=254, verbose_name="Correo del responsable", default=""
    )
    telefono_responsable = models.CharField(
        max_length=20, verbose_name="Teléfono del responsable", default=""
    )
